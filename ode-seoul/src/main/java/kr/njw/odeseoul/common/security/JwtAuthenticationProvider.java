...
public class JwtAuthenticationProvider {
    ...
    public JwtAuthenticationProvider(@Value("${ode-seoul.security.jwt-secret}") String secret,
                                     @Value("${ode-seoul.security.access-token-duration-seconds}") long durationSeconds) {
